                                        ...
                                        <View style={{ justifyContent: 'flex-end', flexDirection: 'row' }}>
                                            {
                                                element.date !== undefined ?
                                                    <Text >Được chi sẻ bởi {word.user_id.username} {new Date(element.date).getFullYear() + '/' + fixDigit(new Date(element.date).getMonth()) + '/' + fixDigit(new Date(element.date).getDate())}</Text>
                                                    :
                                                    null
                                            }
                                        </View>
                        ...
                        <View style={{ padding: 15 }}>
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                <View style={{ flexDirection: 'row', justifyContent: 'flex-start' }}>
                                    <AntDesign name={'close'} size={20}
                                        ...
                                        style={{ marginTop: 5 }} />
                                    <Text style={{ fontWeight: 'bold', fontSize: 20, marginLeft: 10 }}>Chia sẻ  </Text>
                                </View>
                                {sharePersion === 'checked' || sharePrivate ?
                            ...
                            <View>
                                <View style={{ flexDirection: 'row', paddingTop: 20, paddingBottom: 10 }}>
                                    ...
                                    />
                                    <Text style={{ marginTop: 8 }}>Chỉ mình tôi</Text>
                                </View>
                                <View style={{ flexDirection: 'row', paddingBottom: 10 }}>
                                    ...
                                    />
                                    <Text style={{ marginTop: 8 }}>Chia sẻ với những người dùng cụ thể</Text>
                                </View>
                                ...
                                <View style={{ flexDirection: 'row', paddingBottom: 10 }}>
                                    ...
                                    />
                                    <Text style={{ marginTop: 8 }}>Chia sẻ với tất cả người dùng</Text>
                                </View>
                            </View>
